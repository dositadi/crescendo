...
func New(usermodel homepage.UserModel, client herokuapp.HerokuApp, logger jsonlog.Logger, embedded groupietracker.Embedded, favoriteModel homepage.FavoriteModel, preferencemodel homepage.PreferenceModel) *DetailPage {
	return &DetailPage{
		usermodel:       usermodel,
		client:          client,
		logger:          logger,
